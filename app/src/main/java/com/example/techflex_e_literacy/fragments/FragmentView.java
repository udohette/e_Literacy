...
import com.example.techflex_e_literacy.Adapter.ListAdapter;
import com.example.techflex_e_literacy.R;
import com.example.techflex_e_literacy.model.HandleTimetableData;
...
public class FragmentView {
    ...
    private int hour;
    private String subName, subCode, facName, roomNo, timeFrom, timeTo,tma;
    ...
    private void initiateDialog1() {
        ...
        final NumberPicker numberPicker = dialog.findViewById(R.id.hour_picker);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*if (hour > 0) {
                    ...
                    Toast.makeText(context, "Select TMA Number ", Toast.LENGTH_SHORT).show();
                }*/
            }
        });
    ...
    private void initiateDialog2(){
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                subName = "Course Code: "+ sName.getText().toString();
                if (!TextUtils.isEmpty(subName)){
                    dialog.dismiss();
                    initiateDialog3();
                }
                else {
                    sName.setError("Enter Course Code");
                }
            }
        });
        ImageButton btnPrevious = dialog.findViewById(R.id.btn_previous);
    ...
    private void initiateDialog3() {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                subCode = "Matric: "+sCode.getText().toString();
                if (!TextUtils.isEmpty(subCode)) {
                    dialog.dismiss();
                    initiateDialog4();
                } else {
                    sCode.setError("Enter Matric Number");
                }
            }
        });
        ImageButton btnPrevious = dialog.findViewById(R.id.btn_previous);
    ...
    private void initiateDialog4(){
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                facName = "Program: "+fName.getText().toString();
    ...
    private void initiateDialog5() {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                roomNo = "TMA Score: "+rNo.getText().toString();
                if (!TextUtils.isEmpty(roomNo)) {
                    dialog.dismiss();
                    initiateDialog6();
                } else {
                    rNo.setError("Enter Score");
                }
            }
        });
        ImageButton btnPrevious = dialog.findViewById(R.id.btn_previous);
    ...
    private void initiateDialog7() {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String time = new StringBuilder().append("Time Taken: ").append(timeFrom).append(" to ").append(timeTo).toString();
                dialog.dismiss();
