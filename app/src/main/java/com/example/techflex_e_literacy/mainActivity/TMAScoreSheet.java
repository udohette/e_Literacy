...
import com.example.techflex_e_literacy.Adapter.ViewPagerAdapter;
import com.example.techflex_e_literacy.R;
import com.example.techflex_e_literacy.chatApi.ChatAPI;
import com.example.techflex_e_literacy.fragments.Friday;
import com.example.techflex_e_literacy.fragments.Monday;
import com.example.techflex_e_literacy.fragments.Thursday;
import com.example.techflex_e_literacy.fragments.Tuesday;
import com.example.techflex_e_literacy.fragments.Wednesday;
...
public class TMAScoreSheet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tmascore_sheet);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Monday(), "Sheet-0");
        adapter.addFragment(new Tuesday(), "Sheet-1");
        adapter.addFragment(new Wednesday(), "Sheet-2");
        adapter.addFragment(new Thursday(), "Sheet-3");
        adapter.addFragment(new Friday(), "Sheet-4");
    ...
    private void iniDeleteAccDialog() {
        ...
        final Dialog dialog = new Dialog(TMAScoreSheet.this);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(newPass) && !TextUtils.isEmpty(reNewPass) && !TextUtils.isEmpty(oldPass)) {
                    if (newPass.equals(reNewPass)) {
                        ...
                        Toast.makeText(TMAScoreSheet.this, "password incorrect", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private void showSnackBar(String msg, int color){
        ...
        snackbar.setActionTextColor(ContextCompat.getColor(TMAScoreSheet.this, android.R.color.white));
        View snackView = snackbar.getView();
        snackView.setBackgroundColor(ContextCompat.getColor(TMAScoreSheet.this, R.color.colorPrimaryDark));
        TextView textView = snackView.findViewById(com.androidadvance.topsnackbar.R.id.snackbar_text);
        textView.setTextColor(ContextCompat.getColor(TMAScoreSheet.this, color));
        snackbar.show();
    }

    @Override
    public void onBackPressed() {
        Intent intent = new Intent(TMAScoreSheet.this, UserActivity.class);
